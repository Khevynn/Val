...
function FormArticle(props) {
  ...
  return (
    <div className="w-[500px] lg:h-[800px] bg-neutral-800 text-white flex flex-col items-center justify-center space-y-10 rounded-b-xl lg:rounded-r-xl lg:rounded-b-none px-7">
      {/* Botão de entrar */}
