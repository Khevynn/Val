  ...
  return (
    <div className="relative z-0 w-full mb-5 group">
      ...
      <input
        id={props.title}
        name={props.title}
        className={`block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-yello-500 focus:outline-none focus:ring-0 focus:border-yellow-600 peer${props.error && "border border-red-500"}`}
        {...props}
      />
